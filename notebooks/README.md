...
| [`families.py`](../src/fashion/data/families.py) | Groups equal names, equal file hashes, and accepted near-duplicates into product families. It also finds duplicate images with conflicting labels for quarantine. |
