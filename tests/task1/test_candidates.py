...
def test_three_cnn_candidates_have_distinct_explicit_identities() -> None:
    ...
    assert TASK1_BALANCED_WEIGHTED_CANDIDATE.preprocessing == TASK1_MILD_AUG_CANDIDATE.preprocessing
    assert TASK1_BALANCED_WEIGHTED_CANDIDATE.loss.loss_id != TASK1_MILD_AUG_CANDIDATE.loss.loss_id
